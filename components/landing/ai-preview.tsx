        ...
        <div>
          ...
          <div className="mt-10 space-y-6">
            ...
            {[
              ...
              "Priority score for every issue",
            ].map((item) => (
              <div
                key={item}
          ...
          <div className="relative rounded-[36px] border border-white/60 bg-white p-8 shadow-[0_60px_160px_rgba(15,23,42,.18)]">
            ...
            <div className="mt-8 rounded-2xl bg-slate-50 p-6">
              ...
              <p className="leading-8 text-slate-700">
                ...
                However CTR decreased on pages
                with more than 10,000 impressions.

                Updating title tags could recover
                approximately

                <span className="font-bold text-violet-600">

                  {" "}9,400 additional clicks.
              ...
              <div className="flex items-start gap-4 rounded-2xl border p-5">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm text-slate-500">
                    ...
                    Update meta titles on
                    the highest impression pages
